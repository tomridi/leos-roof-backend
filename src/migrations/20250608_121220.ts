...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "catservices" (
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "services" (
  	...
  	"svg_icon_code" varchar NOT NULL,
  	"content01" jsonb NOT NULL,
  	"cover_image_id" integer NOT NULL,
  	"content02" jsonb,
  	"call_to_action_highlighted" varchar,
  ...
  DO $$ BEGIN
   ALTER TABLE "catservices" ADD CONSTRAINT "catservices_background_image_id_media_id_fk" FOREIGN KEY ("background_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
  ...
  DO $$ BEGIN
   ALTER TABLE "services" ADD CONSTRAINT "services_service_category_id_catservices_id_fk" FOREIGN KEY ("service_category_id") REFERENCES "public"."catservices"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_catservices_fk" FOREIGN KEY ("catservices_id") REFERENCES "public"."catservices"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "catservices_background_image_idx" ON "catservices" USING btree ("background_image_id");
  CREATE INDEX IF NOT EXISTS "catservices_updated_at_idx" ON "catservices" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "catservices_created_at_idx" ON "catservices" USING btree ("created_at");
  ...
  CREATE INDEX IF NOT EXISTS "services_service_category_idx" ON "services" USING btree ("service_category_id");
  CREATE INDEX IF NOT EXISTS "services_cover_image_idx" ON "services" USING btree ("cover_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "locations_gallery_order_idx" ON "locations_gallery" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "locations_gallery_parent_id_idx" ON "locations_gallery" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "locations_gallery_image_idx" ON "locations_gallery" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "locations_thumbnail_idx" ON "locations" USING btree ("thumbnail_id");
  CREATE INDEX IF NOT EXISTS "locations_cover_image_idx" ON "locations" USING btree ("cover_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "galleries_images_image_idx" ON "galleries_images" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_catservices_id_idx" ON "payload_locked_documents_rels" USING btree ("catservices_id");
